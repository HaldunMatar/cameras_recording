...
class StartRequest {
  ...
  /// Output container format: 'ts' or 'mp4'
  /// 'ts'  → MPEG-TS  — survives hard cuts, playable even if recording crashes
  /// 'mp4' → fragmented MP4 — better compatibility with most players
  final String format;
  ...
  const StartRequest({
    ...
    this.fps = 15,
    this.crf = 23,
    this.format = 'ts', // default matches backend default
  });
